...
public class ControladorEvolucion {
    ...
    public ResponseEntity<Object> crearDiagnostico(@RequestBody DiagnosticoDTO diagnosticoDTO, @RequestParam(required = false) String emailManual) {
        Long cuilDelMedico = 123456789L; // Simulación del CUIL del médico autenticado
        ...
        try {
            ...
            // Si el diagnóstico no está en TipoDiagnostico, devolver un mensaje de error
    ...
    public ResponseEntity<Evolucion> agregarEvolucion(
        ...
        return ResponseEntity.ok()
                .header("pdf-url", "/ruta/del/pdf/" + pdfPath)
                .body(nuevaEvolucion);
    }
    ...
    public ResponseEntity<Evolucion> modificarEvolucion(
